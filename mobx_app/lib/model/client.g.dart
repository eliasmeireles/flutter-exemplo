...
mixin _$Client on _ClientBase, Store {
  ...
  final _$middleNameAtom = Atom(name: '_ClientBase.middleName');
  ...
  @override
  dynamic changeMiddleName(String value) {
    final _$actionInfo = _$_ClientBaseActionController.startAction(
        name: '_ClientBase.changeMiddleName');
    try {
      return super.changeMiddleName(value);
    } finally {
      _$_ClientBaseActionController.endAction(_$actionInfo);
    }
  }
